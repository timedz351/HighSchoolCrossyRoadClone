...
##    mozem=True
    ...
    canvas.create_rectangle([76, 578, 253, 640],fill='white',tags='butStart',width=4)
    canvas.create_text(164.5,609,text=Text,tags='butStart')#text v tlacidle, podla toho ci som prehal alebo nie


def klik(s):
    #ak je zastavena hra, mozem kliknut na tlacitko
    if not mozem:
        if 76<s.x<253 and 578<s.y<640:
